...
import com.example.scalsandroid.scals.components.compose.renderers.ButtonComposeRenderer
...
import com.example.scalsandroid.scals.components.resolvers.ButtonResolver
...
object ButtonBundle : ComponentBundle {
    override val componentKind = ComponentKind("button")
    override val nodeKind: RenderNodeKind = RenderNodeKinds.BUTTON
    override fun makeResolver(): ComponentResolving = ButtonResolver()
    override fun makeComposeRenderer(): ComposeNodeRendering = ButtonComposeRenderer()
}
